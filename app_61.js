...
const DBPATH = 'curriculooficial.db';

const bodyParser = require('body-parser');
const urlencodedParser = bodyParser.urlencoded({ extended: false })

app.use(express.static("cindex.html"));
...
app.post('/insert', urlencodedParser, (req, res) => {
	...
	sql = `INSERT INTO curriculooficial (outrascompetencias) VALUES ('${req.body.outrascompetencias}')`;
